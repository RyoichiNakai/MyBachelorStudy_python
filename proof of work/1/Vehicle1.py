...
my_p2p_client = None
f = open('/home/ryoichi/Templates/BlockchainProjects/vehicle/misvehicle1.json', 'r')
...
def main():
    ...
    global my_p2p_client
    my_p2p_client = ClientCore(50095, '172.20.69.203', 50070)
    my_p2p_client.start()
    ...
    for t in json_dict:
        ...
        print(tx_strings)
        with open('/home/ryoichi/Templates/BlockchainProjects/result/result_1.txt', 'w') as file:
            file.write(str(cnt))
        sleep(0.08)
