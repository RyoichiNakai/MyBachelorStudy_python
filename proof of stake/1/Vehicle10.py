...
my_p2p_client = None
f = open('/home/ryoichi/Templates/BlockchainProjects/vehicle/vehicle10.json', 'r')
...
def main():
    ...
    global my_p2p_client
    my_p2p_client = ClientCore(50077, '172.20.69.203', 50088)
    my_p2p_client.start()
    ...
    for t in json_dict:
        ...
        print(tx_strings)
        with open('/home/ryoichi/Templates/BlockchainProjects/result/result_10.txt', 'w') as file:
            file.write(str(cnt))
        sleep(0.1)
