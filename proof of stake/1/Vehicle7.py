...
my_p2p_client = None
f = open('/home/ryoichi/Templates/BlockchainProjects/vehicle/vehicle7.json', 'r')
...
def main():
    ...
    global my_p2p_client
    my_p2p_client = ClientCore(50083, '172.20.69.206', 50082, 7)
    my_p2p_client.start()
    ...
    for t in json_dict:
        ...
        print(tx_strings)
        with open('/home/ryoichi/Templates/BlockchainProjects/result/result_7.txt', 'w') as file:
            file.write(str(cnt))
        sleep(0.1)
