...
my_p2p_client = None
f = open('/home/ryoichi/Templates/BlockchainProjects/vehicle/vehicle8.json', 'r')
...
def main():
    ...
    global my_p2p_client
    my_p2p_client = ClientCore(50081, '172.20.69.206', 50084, 8)
    my_p2p_client.start()
    ...
    for t in json_dict:
        ...
        print(tx_strings)
        with open('/home/ryoichi/Templates/BlockchainProjects/result/result_8.txt', 'w') as file:
            file.write(str(cnt))
        sleep(0.1)
