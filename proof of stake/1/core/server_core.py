...
class ServerCore(object):
    ...
    def __init__(self, my_port=50082, core_node_host=None, core_node_port=None, server_id=1):
        ...
        my_genesis_block = self.bb.generate_genesis_block(self.server_id)
    ...
    def __generate_block_with_tp(self):
        ...
        while self.flag_stop_block_build is not True:
            ...
            if len(new_tp) == 0:
                break
            new_block = self.bb.generate_new_block(new_tp, self.prev_block_hash, self.server_id)
