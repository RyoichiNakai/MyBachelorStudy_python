...
my_p2p_client = None
f = open('/home/ryoichi/Templates/BlockchainProjects/vehicle/vehicle5.json', 'r')
...
def main():
    ...
    global my_p2p_client
    my_p2p_client = ClientCore(50087, '172.20.69.205', 50078, 5)
    my_p2p_client.start()
    ...
    for t in json_dict:
        ...
        print(tx_strings)
        with open('/home/ryoichi/Templates/BlockchainProjects/result/result_5.txt', 'w') as file:
            file.write(str(cnt))
        sleep(0.1)
